...
class ActivityLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        SAVINGS_ACCOUNT_UPDATED = "savings_account_updated", "Savings account updated"
        SAVINGS_ACCOUNT_DELETED = "savings_account_deleted", "Savings account deleted"
        SAVINGS_CLOSED = "savings_closed", "Savings account closed"
        MUTUAL_AID_ENROLLED = "mutual_aid_enrolled", "Mutual aid enrolled"
        MUTUAL_AID_MEMBERSHIP_UPDATED = "mutual_aid_membership_updated", "Mutual aid membership updated"
        MUTUAL_AID_MEMBERSHIP_DELETED = "mutual_aid_membership_deleted", "Mutual aid membership deleted"
